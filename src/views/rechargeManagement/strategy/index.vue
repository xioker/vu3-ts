...
let searchForm = reactive<IRechargeSearch>({name: '', startTime: null, endTime: null})
let searchForms: any[] = [
  {el: 'input', prop: 'name', label: '策略名称', placeholder: '请输入策略名称'},
  {el: 'timeRange',  propStart: 'startTime', propEnd:'endTime', label: '执行时间'},
  {el: 'button',options: [

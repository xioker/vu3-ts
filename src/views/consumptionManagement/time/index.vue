...
import { ITime, ITimeSearch } from '@/types/modules/consumption'
let searchForm = reactive<ITimeSearch>({ name: '', status: '' })
let searchForms: any[] = [
  {el: 'input', prop: 'name', label: '消费时段组名', placeholder: '请输入消费时段组名'},

...
import { IReturn, IReturnSearch } from '@/types/modules/consumptionRecord'
let searchForm = reactive<IReturnSearch>({
  name: '', code: '', startTime: null, endTime: null })
let searchForms: any[] = [
  {el: 'input', prop: 'name', label: '用户', placeholder: '请输入用户'},
  {el: 'input', prop: 'code', label: '用户号', placeholder: '请输入用户号'},
  {el: 'timeRange', propStart: 'startTime', propEnd: 'endTime', label: '退补时间'},
  {el: 'button',options: [

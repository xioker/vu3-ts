...
import { IBill, IBillSearch } from '@/types/modules/consumptionRecord'
let searchForm = reactive<IBillSearch>({ orderId: '', personName: '', goodName: '' })
let searchForms: any[] = [
  {el: 'input', prop: 'personName', label: '用户', placeholder: '请输入用户'},
  {el: 'input', prop: 'orderId', label: '账单号', placeholder: '请输入账单号'},
  {el: 'input', prop: 'goodName', label: '商品名', placeholder: '请输入商品名'},
  {el: 'button',options: [
